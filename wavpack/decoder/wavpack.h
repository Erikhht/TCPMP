...
#if !defined(__GNUC__) || defined(WIN32) || defined(__palmos__) || defined(__SYMBIAN32__)
...
typedef long (*read_stream)(void *, long, void *);
...
void WavpackFlush (WavpackContext *wpc); //TCPMP
